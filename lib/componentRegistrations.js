...
/*jslint todo: true, vars:true, regexp: true*/
/**
...
module.exports = function () { // listener
    ...
    var dirComponent = registerComponent({
    ...
    var docComponent = registerComponent({
    ...
    return { // Public API
        unregister: function (reason) { // ("uninstall" has issue per https://bugzilla.mozilla.org/show_bug.cgi?id=627432 ), disable, shutdown, upgrade, downgrade
            dirComponent.unregister();
            docComponent.unregister();
            fileTypeProtocolDict = null;
            permittedURIDict = null;
            // For simple-prefs not uninstalling automatically, see
            //   https://bugzilla.mozilla.org/show_bug.cgi?id=627432
            // if (reason === 'uninstall') {
            //     // Could manually unset all prefs properties in use
            //}
        },
